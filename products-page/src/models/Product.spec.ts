...
beforeEach(function():void{    
    product = new Product({name: 'name1', price: 1, categoryDTO: category1});
});
...
it('getCategory what it setted in constructor before',function():void{ 
    expect(product.getCategoryDTO()).toStrictEqual(category1);
});
...
it('getCategory what it setted with set before',function():void{
    ...
    product.setCategoryDTO(category2);
    expect(product.getCategoryDTO()).toBe(category2);
});
